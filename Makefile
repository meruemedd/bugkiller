.PHONY: setup pull dev pull-dev stop mobile logs optimize watch-projects sync-projects help
...
help:
	...
	@echo "  watch-projects  监听本地多项目，有改动则各自 commit/push"
	@echo "  sync-projects   扫描一轮本地多项目并提交（不常驻）"
